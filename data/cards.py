...
saints = {
    ...
    "saint-michael": ["saint", "Michael the Archangel", "all", 70, 750, 80, 60, []]
}
...
divines = {
    "almighty-god": ["divine", "Almighty God", "all", 100, 100000, 100000, 100000, ["divine-wrath"]],
    "jesus-christ": ["divine", "Lord Jesus Christ", "all", 100, 1000, 500, 500, ["son-of-god", "resurrection"]],
}

demons = {
    "demon-knight": ["demon", "Demon Knight", "demon", 10, 50, 10, 10, []],
    "demon-sorcerer": ["demon", "Demon Sorcerer", "demon", 10, 50, 10, 10, []],
    "demon-warlord": ["demon", "Demon Warlord", "demon", 30, 100, 30, 30, []],
}

horsemen = {
    "horseman-conquest": ["horseman", "Conquest", "horseman", 50, 500, 80, 50, []],
    "horseman-war": ["horseman", "War", "horseman", 50, 500, 90, 60, []],
    "horseman-famine": ["horseman", "Famine", "horseman", 50, 500, 70, 80, []],
    "horseman-death": ["horseman", "Death", "horseman", 50, 500, 100, 100, []],
}

# I know St. Michael is both. Multiple categories will be allowed
angels = {
    "angel-cherubim": ["angel", "Cherubim", "all", 40, 400, 60, 60,[]],
    #"angel-throne": ["Throne", "angel", 40, 400, 60, 60,[]],
}

# Temporary category
others = {
    "moses": ["other", "Moses", "all", 80, 800, 90, 90, []],
    "john-the-baptist": ["other", "John the Baptist", "all", 80, 800, 90, 90, []],
}
